    ...
    <div class="container mx-auto px-4">
        <div class="game-details border-b border-gray-800 pb-12 flex flex-col lg:flex-row">
            ...
            <div class="lg:ml-12 lg:mr-64">
                ...
                <div class="flex flex-wrap items-center mt-8 space-x-12">
                    <div class="flex items-center">
                        <div class="w-16 h-16 bg-gray-800 rounded-full">
                            ...
                            <div class="text-xs ml-4">Member <br> Score</div>
                    </div>
                    <div class="flex items-center">
                        <div class="w-16 h-16 bg-gray-800 rounded-full">
                            <div class="font-semibold text-xs flex justify-center items-center h-full">92%</div>
                        </div>
                            <div class="text-xs ml-4">Critic <br> Score</div>
                    </div>
                    <div class="flex lg:items-center space-x-4 mt-4 lg:mt-0 lg:ml-12">
                ...
                <p class="mt-12">A spectacular re-imagining of one of the most visionary games ever, Final Fantasy VII Remake rebuilds and expands the legendary RPG for today. The first game in this project will be set in the eclectic city of Midgar and presents a fully standalone gaming experience.</p>
        ...
        <div class="images-container border-b border-gray-800 pb-12 mt-8">
            ...
            <div class="grid gap-12 grid-cols-1 md:grid-cols-2 xl:grid-cols-3 mt-8">
                <div>
                    <a href="#">
                        <img src="/img/screenshot1.jpg" alt="" class="hover:opacity-75 transition ease-in-out duration-150">
                    </a>
                </div>
                <div>
                    <a href="#">
                        <img src="/img/screenshot2.jpg" alt="" class="hover:opacity-75 transition ease-in-out duration-150">
                    </a>
                </div>
                <div>
                    <a href="#">
                        <img src="/img/screenshot3.jpg" alt="" class="hover:opacity-75 transition ease-in-out duration-150">
                    </a>
                </div>
                <div>
                    <a href="#">
                        <img src="/img/screenshot4.jpg" alt="" class="hover:opacity-75 transition ease-in-out duration-150">
                    </a>
                </div>
                <div>
                    <a href="#">
                        <img src="/img/screenshot5.jpg" alt="" class="hover:opacity-75 transition ease-in-out duration-150">
                    </a>
                </div>
                <div>
                    <a href="#">
                        <img src="/img/screenshot6.jpg" alt="" class="hover:opacity-75 transition ease-in-out duration-150">
                    </a>
                </div>
            </div>
        ...
        <div class="similar-container border-b border-gray-800 pb-12 mt-8">
            ...
            <div class="similar-games text-sm grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 xl:grid-cols-6 gap-12">
                ...
                <div class="game mt-8">
                    <div class="relative inline-block">
                        <a href="#">
                            <img src="/img/alyx.jpg" alt="game cover" class="hover:opacity-75 transition ease-in-out duration-150">
                        </a>
                        <div class="absolute bottom-0 right-0 w-16 h-16 bg-gray-800 rounded-full" style="right: -20px; bottom: -20px">
                            <div class="font-semibold text-xs flex justify-center items-center h-full">
                                80%
                ...
                <div class="game mt-8">
                    <div class="relative inline-block">
                        <a href="#">
                            <img src="/img/luigi.jpg" alt="game cover" class="hover:opacity-75 transition ease-in-out duration-150">
                        </a>
                        <div class="absolute bottom-0 right-0 w-16 h-16 bg-gray-800 rounded-full" style="right: -20px; bottom: -20px">
                            <div class="font-semibold text-xs flex justify-center items-center h-full">
                                80%
                ...
                <div class="game mt-8">
                    <div class="relative inline-block">
                        <a href="#">
                            <img src="/img/resident.jpg" alt="game cover" class="hover:opacity-75 transition ease-in-out duration-150">
                        </a>
                        <div class="absolute bottom-0 right-0 w-16 h-16 bg-gray-800 rounded-full" style="right: -20px; bottom: -20px">
                            <div class="font-semibold text-xs flex justify-center items-center h-full">
                                80%
